    ...
    <body>
        ...
        <div class="topbar">
            ...
            <div class="contents"> 
                ...
                <label style="font-size: 100px" >Schedules</label>
                <br><br><br>

                <table>
                        <th><label style = "color: white;">Schedule ID</label></th>
                        <th><label style = "color: white;">Room</label></th>
                        <th><label style = "color: white;">Instructor</label></th>
                        <th><label style = "color: white;">Role</label></th>
                        <th><label style = "color: white;">Day</label></th>
                        <th><label style = "color: white;">Time Start</label></th>
                        <th><label style = "color: white;">Time End</label></th>
                        <?php if (isset($role) && ($role === 'Admin' || $role === 'Staff')) { ?>
                    ...
                    ?>
                    <tr>
                        <td style="text-align: center;"><?php echo $row["Sched_id"]; ?></td>
                        ...
                        <?php if (isset($role) && ($role === 'Admin' || $role === 'Staff')) { ?>
                        <td><a href="delete_sched.php?sched_id=<?php echo $row['Sched_id']; ?>" onclick="return confirm('Are you sure you want to delete this user?');"><button>Delete</button></a></td>
                        <?php } ?>
                    </tr>
                    <?php
                        $i++;
                    ...
                    <?php if (isset($role) && ($role === 'Admin' || $role === 'Staff')) { ?>
                    <tr>
                        <td style="text-align: center;"><a href="add_schedule.php"><button>Add New</button></a></td>
                    </tr>
                    <?php } ?>
                </table>
                <?php
