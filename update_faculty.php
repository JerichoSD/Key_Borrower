<?php
    ...
    if (isset($_GET['emp_id'])) {
        ...
        $sql = "SELECT * FROM FacultyProfile WHERE Emp_id = '$emp_id'";
        ...
        echo "<script>alert('No profile selected.'); window.location.href='profile_account.php';</script>";
        exit();
    }
    mysqli_close($conn);
?>
...
<body>
    ...
    <div class="contents">
        ...
        <form action="change_dep.php?emp_id=<?php echo $emp_id; ?>" method="post">
            <table>
            <br>
                <th colspan = "2">Change Department for <?php echo $emp['Name']; ?></th>
                <tr>
