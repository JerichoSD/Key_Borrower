...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['pic']) && $_FILES['pic']['error'] === UPLOAD_ERR_OK) {
        ...
        echo "Error: Image upload is required.";
        exit();
    }

    $sql = "SELECT Emp_id FROM FacultyProfile ORDER BY Emp_id DESC LIMIT 1";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $newId = "emp" . str_pad($numpart, 3, "0", STR_PAD_LEFT);
    } else {
        $newId = "emp201";
    }

    $checkUserQuery = "SELECT * FROM FacultyProfile WHERE Emp_id = '$newId'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO FacultyProfile (Emp_id, Name, College, Department, Picture) VALUES ('$newId', '$name', '$col', '$dep', '$path')";
...
<body>
    ...
    <div class="contents">
        <label style="font-size: 100px">Create Faculty Profile</label>
        <br>
        <form action="add_faculty.php" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="file" id="pic" name="pic" required></td>
                </tr>
                <tr>
